<style type="text/css">
  #galeri .jumbotron{
    background-image: url(<?=base_url('assets/images/1homepage.WEBP')?>);
  ...
  .gallery {
  padding-bottom: 600px; /* Tambahkan jarak pada bagian galeri */
}
        ...
        <div class="jumbotron jumbotron-fluid mb-0">
          <div class="container">
            <div id="text">
              ...
              <p class="lead"> Dive into Our Captivating Gallery of Moments and Memories.</p>
            </div>
          </div>
        </div>
      </div>
