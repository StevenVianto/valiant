...
namespace Rubeka_cafe.Controllers
{
    ...
    public class GalleriesController : ControllerBase
    {
        ...
        public GalleriesController(rDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Gallery>> PostGallery(Gallery gallery)
        {
            ...
            return CreatedAtAction("GetGallery", new { id = gallery.IdGallery }, gallery);
        }
        ...
        {
            return _context.Galleries.Any(e => e.IdGallery == id);
        }
    }
}
